...
**
*******************************************************************************/
#ifndef _canadarm_app_msg_h_
#define _canadarm_app_msg_h_

/**
 * CanadarmApp command codes
 */
#define CANADARM_APP_NOOP_CC        0
#define CANADARM_APP_MOVE_CC   1
